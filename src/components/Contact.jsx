  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-2 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch]">Contact</h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[500ch] lg:max-w-[30ch]">
            Reach Me Out On Social Media Platforms Below 👇 and start to make
            something amazing
          </p>
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                target="_blank"
                href={href}
                className="grid active:bg-zinc-50/80 hover:text-zinc-950 w-12 h-12 place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://formspree.io/f/mbljoewg"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="Halo"
                required
                className="text-field resize-y min-h-32 mx-h-80"
              ></textarea>
            </div>
            <button
              type="submit"
